...
export const CellRenderer = memo(function CellRenderer({
  ...
  return (
    ...
    >
      ...
      <div className={`absolute -top-3 left-2 flex items-center gap-0.5 text-[10px] z-10 bg-popover shadow-lv1 rounded px-1 py-0.5 border border-border/50 transition-opacity ${
